...
public class LegacyMetaServerProvider implements MetaServerProvider {
  ...
  private void initialize() {
    ...
    domains.put(Env.QASA, getMetaServerAddress(prop, "dev_meta", "qasa.meta"));
    domains.put(Env.QASB, getMetaServerAddress(prop, "dev_meta", "qasb.meta"));
    ...
    domains.put(Env.UATA, getMetaServerAddress(prop, "uata_meta", "uata.meta"));
    domains.put(Env.UATB, getMetaServerAddress(prop, "uatb_meta", "uatb.meta"));
